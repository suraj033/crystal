$(function () {
    ...
    $('.chat-textarea input').on("keypress", function(e){
        ...
        var $my_avt = 'http://www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&f=y';
        var $your_avt = 'https://secure.gravatar.com/avatar/60e6fca61ba7dd347a48b1faa00bc339';
        if (e.which == 13) {
            var $content = $obj.val();
