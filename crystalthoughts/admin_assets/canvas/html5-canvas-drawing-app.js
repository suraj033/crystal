...
var padding = 25;
var lineWidth = 8;
//var colorBlack = "#000000";   ***Purple replaced with Black
...
function prepareCanvas()
{
	...
	crayonImage.src = "/admin_assets/canvas/images/crayon-outline.png";
	//context.drawImage(crayonImage, 0, 0, 100, 100);
	
	markerImage.onload = function() { resourceLoaded(); 
	};
	markerImage.src = "/admin_assets/canvas/images/marker-outline.png";
	
	eraserImage.onload = function() { resourceLoaded(); 
	};
	eraserImage.src = "/admin_assets/canvas/images/eraser-outline.png";
	
	crayonBackgroundImage.onload = function() { resourceLoaded(); 
	};
	crayonBackgroundImage.src = "/admin_assets/canvas/images/crayon-background.png";
	
	markerBackgroundImage.onload = function() { resourceLoaded(); 
	};
	markerBackgroundImage.src = "/admin_assets/canvas/images/marker-background.png";
	
	eraserBackgroundImage.onload = function() { resourceLoaded(); 
	};
	eraserBackgroundImage.src = "/admin_assets/canvas/images/eraser-background.png";

	crayonTextureImage.onload = function() { resourceLoaded(); 
	};
	crayonTextureImage.src = "/admin_assets/canvas/images/crayon-texture.png";
	
	outlineImage.onload = function() { resourceLoaded(); 
	};
	outlineImage.src = "/admin_assets/canvas/images/bg-outline.png";
	...
	$('#canvas').mousedown(function(e)
	{
		...
		$("#mouse_x").html(mouseX + ' --------- ' + this.offsetLeft);
		$("#mouse_y").html(mouseY + ' --------- ' + this.offsetTop);
